...
const Banner = () => {
    ...
    return (
        <div className='relative w-full overflow-hidden banner'>
            <div ref={bannerRef} className="flex fixed top-0 z-10 flex-col items-center min-h-screen my-container pt-44 text-white" onMouseMove={handleMouseMove}>
